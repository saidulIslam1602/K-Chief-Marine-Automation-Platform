...
/// </summary>
public class AuthenticationService : IKChiefAuthenticationService
{
        ...
        ILogger<AuthenticationService> logger)
    {
        ...
        _jwtIssuer = _configuration["Authentication:JWT:Issuer"] ?? "KChief.Platform.API";
        _jwtAudience = _configuration["Authentication:JWT:Audience"] ?? "KChief.Platform.API";
    ...
    public async Task<KChiefTokenValidationResult> ValidateTokenAsync(string token)
    {
        try
        {
            ...
            return new KChiefTokenValidationResult
            {
                IsValid = true,
                UserId = userId,
                Username = username,
